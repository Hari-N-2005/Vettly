...
export default function ProjectWorkspaceNav() {
  ...
  return (
    <section className="sticky top-16 z-30 border-y border-indigo-400/40 bg-gradient-to-r from-slate-950 via-indigo-900/35 to-slate-950 px-4 py-3 shadow-[0_8px_22px_rgba(67,56,202,0.18)] ring-1 ring-indigo-400/25 backdrop-blur sm:px-6">
